...
(function() {
  jQuery(function() {
    var categories, microcategories;
    categories = $('#modulo1_categorie_id').html();
    $('#modulo1_macrocategorie_id').change(function() {
      var macrocategorie, options;
      macrocategorie = $('#modulo1_macrocategorie_id :selected').text();
      options = $(categories).filter("optgroup[label='" + macrocategorie + "']").html();
      if (options) {
        return $('#modulo1_categorie_id').html(options);
      } else {
        return $('#modulo1_categorie_id').empty();
      }
    });
    microcategories = $('#modulo1_microcategorie_id').html();
    return $('#modulo1_categorie_id').change(function() {
      var categorie, options;
      categorie = $('#modulo1_categorie_id :selected').text();
      options = $(microcategories).filter("optgroup[label='" + categorie + "']").html();
      if (options) {
        return $('#modulo1_microcategorie_id').html(options);
      } else {
        return $('#modulo1_microcategorie_id').empty();
      }
    });
  });
